...
app = FastAPI(
    title="Leitor de Simulados",
    description="Web application for scanning and processing exam answer sheets",
    version="2.0.0"
)
...
async def home(request: Request):
    ...
    return templates.TemplateResponse("index.html", {
        "request": request,
        "test_types": [t.name for t in TestType if t != TestType.NULL],
        "models": processing_service.get_available_models()
    })
